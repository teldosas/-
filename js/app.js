...
var PharmacyView = Backbone.View.extend({
    initialize: function() {
		...
		var mapsUrl = 'https://maps.google.com/maps?q='+place.lat+'%2C%20'+place.lng+'&hl=el&t=t&z=13&ie=UTF8&iwloc=&output=embed';
		this.model.set('mapsUrl', mapsUrl);
        this.rendered = false;
    },
    className: 'pharmacy',
    tagName: 'tr',
    template: _.template('<td colspan="6">' +
        ...
        '</div>' +
        '<div class="ph-map">'+
		'<iframe width="850" height="350" id="gmap_canvas" src="<%= mapsUrl %>" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>' +					 
		'</div>' +
        '</td>'),
    render: function() {
